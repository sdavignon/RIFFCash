...
uint256 hashGenesisBlock("0x7682dbfd7f9fe5f808c760d61b3a9adde7363c0166d6153196de7f01cf0f2f4c");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // RIFFCash: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "RIFFCash Signed Message:\n";
...
{
    // RIFFCash: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // RIFFCash: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // RIFFCash: 3.5 days
static const int64 nTargetSpacing = 150; // RIFFCash: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // RIFFCash: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // RIFFCash: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7ed7ba24b79dc734c3bd3711270cf8f4318bd7a368e7c50d2f0bbd34db3d1961");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Real-time Infrastructure Fortified Finance";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("ecfcfcb0e5991c0ae90ed781c580e622ef85e23be335d840a28742e117f25c92da376125911da3ece1f95ba058b8f499f9a5a414c61225b2d973214adf8738e849") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1511636205;
        block.nBits    = 504365644;
        block.nNonce   = 3830793316;

        if (fTestNet)
        {
            block.nTime    = 1511636205;
            block.nNonce   = 88369200;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x594c1739eadd56ee4dbe2482495ea3bb0ac1abf9596e9d882692aeb13b1891ea"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // RIFFCash: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RIFFCashMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RIFFCashMiner : ProcessBlock, block not accepted");
    }
