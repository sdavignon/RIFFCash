...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s riffcash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  riffcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded riffcash transaction") + "\n" +
              "  riffcash-tx [options] -create [commands]   " + _("Create hex-encoded riffcash transaction") + "\n" +
              "\n";
