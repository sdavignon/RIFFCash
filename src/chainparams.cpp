...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.riffcash.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.riffcashtools.com", true);
        vSeeds.emplace_back("dnsseed.riffcashpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.riffcashtools.com", true);
        vSeeds.emplace_back("seed-b.riffcash.loshan.co.uk", true);
